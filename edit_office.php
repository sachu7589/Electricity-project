...
<?php
    ...
    if(isset($_GET['O_id'])){
        $O_id=$_GET['O_id'];
        require_once "connect.php";
        $sql="SELECT * FROM tbl_offices WHERE  O_id='$O_id' AND O_status=1;";
        $result=$conn->query($sql);
        $row=$result->fetch_assoc();
        $ph=$row['O_phone'];
        $email=$row['O_email'];
    ...
    if(isset($_POST['submit'])){     
        ...
        require_once "connect.php";
        $sql="UPDATE tbl_offices SET O_phone='$ph', O_email='$email', O_area='$area', O_postal='$po', O_street='$street', O_city='$city', O_landmark='$landmark', O_district='$district' WHERE O_id=$O_id;";
...
setTimeout(function() {
  window.location.href = "manage_office.php"; // Replace "another_page.php" with the URL of the page you want to redirect to
}, 2000);
            </script>
            </html>
           <?php
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Edit offices</li>
          </ol>
                  ...
                  <form action="#" method="POST" class="p-5" onsubmit="return validateForm()">
                      ...
                      <div class="col-md-6">
                        <div class="form-group first">
                          ...
                          <input type="text" class="form-control" id="ph" name="ph" onblur="validatePhoneNumber()"
                            oninput="validatePhoneNumber()" value="<?php echo $ph; ?>">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group first">
                          <label>Area </label>
                          <input type="text" class="form-control" id="area" name="area" onblur="validateArea()" oninput="validateArea()" value="<?php echo $area; ?>">
                      ...
                      <div class="col-md-6">
                        <div class="form-group first">
                          ...
                          <input type="number" class="form-control" id="po" name="po" onblur="validatePostalCode()"
                            oninput="validatePostalCode()" value="<?php echo $po; ?>">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group last mb-3">
                          ...
                          <input type="text" class="form-control" id="street" name="street"
                            onblur="validateStreetName()" oninput="validateStreetName()"   value="<?php echo $street; ?>">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group last mb-3">
                          ...
                          <input type="text" class="form-control" id="city" name="city" onblur="validateCity()"
                            oninput="validateCity()" value="<?php echo $city; ?>">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group last mb-3">
                          ...
                          <input type="text" class="form-control" id="landmark" name="landmark" onblur="validateLandmark()" oninput="validateLandmark()" value="<?php echo $landmark; ?>">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group last mb-3">
                          <label>Distrct</label>
                          <select class="form-select" aria-label="Default select example" id="district" name="district" value="<?php echo $district; ?>">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                      <input type="submit" value="Update" class="btn px-5 btn-primary" name="submit">
                    </div>
