...
<?php
    ...
    if(isset($_GET['E_id'])){
        $E_id=$_GET['E_id'];
        require_once "connect.php";
        $sql="SELECT * FROM tbl_employees WHERE E_id='$E_id' AND E_status=1;";
        $result=$conn->query($sql);
        $row=$result->fetch_assoc();
        $fname=$row['E_fname']; 
        $lname=$row['E_lname'];
...
setTimeout(function() {
  window.location.href = "manage_employee.php"; // Replace "another_page.php" with the URL of the page you want to redirect to
}, 2000);
            </script>
            </html>
           <?php
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Edit Employee</li>
          </ol>
                      ...
                      <div class="col-md-6">
                        <div class="form-group first">
                          ...
                          <input type="text" class="form-control" id="fname" name="fname" onblur="validateFirstName()"
                            oninput="validateFirstName()" value="<?php echo $fname; ?>">
                      ...
                      <div class="col-md-6">
                        <div class="form-group first">
                          ...
                          <input type="text" class="form-control" id="lname" name="lname" onblur="validateLastName()"
                            oninput="validateLastName()" value="<?php echo $lname; ?>">
                      ...
                      <div class="col-md-6">
                        <div class="form-group first">
                          ...
                          <input type="text" class="form-control" id="so" name="so" onblur="validateSonOf()"
                            oninput="validateSonOf()" value="<?php echo $so; ?>">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group last mb-3">
                          ...
                          <input type="date" class="form-control" id="dob" name="dob"
                            min="<?php echo $fiftyYearsAgo; ?>" max="<?php echo $eighteenYearsAgo; ?>" onkeydown="return false" onpaste="return false" value="<?php echo $dob; ?>">
