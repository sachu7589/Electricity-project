            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Manage offices</li>
                    </ol>
        ...
        <div class="container-fluid py-4">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end pt-3">
                <a href="add_office.php">
                    <button class="btn btn-light me-md-2" type="button">Add Offices</button>
                </a>
            </div>
            <div class="container-fluid py-4">
                <div class="row">
                            ...
                            <div class="card-body px-0 pt-0 pb-2">
                                <div class="table-responsive p-0">
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql="SELECT * FROM tbl_offices WHERE O_status=1;";
                                            $result=$conn->query($sql);
