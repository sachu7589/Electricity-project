            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Allocation</li>
                    </ol>
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                    <?php
                                            $sql="SELECT * FROM tbl_offices, tbl_allocate WHERE tbl_offices.O_id = tbl_allocate.Alloc_officeid AND tbl_offices.O_status = 1;";
                                            $result=$conn->query($sql);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="mb-0 text-">
                                                       Street :  <?php echo $rows['O_street']; ?> <br>
                                                        ...
                                                        Landmark : <?php echo $rows['O_landmark']; ?> <br>
                                                        District : <?php echo $rows['O_district']; ?>
                                                    </h6>
                                                </td>
                                                <td>
                                                    <h6 class="mb-0 text-">
                                                        ...
                                                        if($rows['Alloc_manager']==0){
                                                            ...
                                                            $Alloc_manager=$rows['Alloc_manager'];
                                                            $sql2="SELECT E_fname,E_lname FROM tbl_employees WHERE E_id=$Alloc_manager AND E_status=1;";
                                                            $result2=$conn->query($sql2);
                                                            if($result2->num_rows>0){
                                                                $row2=$result2->fetch_assoc();
                                                                echo $row2['E_fname'].' '.$row2['E_lname'];
                                                            }
                                                            else{
                                                ...
                                                <td>
                                                    ...
                                                    if($rows['Alloc_meter']==0){
                                                        ...
                                                        $Alloc_meter=$rows['Alloc_meter'];
                                                        $sql3="SELECT E_fname,E_lname FROM tbl_employees WHERE E_id=$Alloc_meter AND E_status=1;";
                                                        $result3=$conn->query($sql3);
                                                        if($result3->num_rows>0){
                                                            $row3=$result3->fetch_assoc();
                                                            echo $row3['E_fname'].' '.$row3['E_lname'];
                                                        }
                                                        else{
                                                            echo "Employee removed";
                                                        }
