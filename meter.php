<?php
    ...
    if(isset($_SESSION['L_id']) ){
        ...
        if($L_type_id==3 && $E_level=="meter reader"){
            ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="meter.php">
                <img src="images/bg1.jpg" class="navbar-brand-img h-100" alt="main_logo">
                <span class="ms-1 font-weight-bold">meter reader</span>
            </a>
        </div>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link " href="#">
                        ...
                        <span class="nav-link-text ms-1">Enter</span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">meter reader</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Employee</h6>
                </nav>
                                ...
                                <div class="table-responsive p-0">
                                    <div>
                                        <img src="images/adm.jpg"
                                            style="height: 700px; width: 100%; opacity: 0.5; border-radius: 16px;">
                                    </div>
                                </div>
                            </div>
                        </div>
